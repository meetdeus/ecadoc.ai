...
export const SiteFooter = () => (
  <footer className="bg-secondary dark:bg-background-8 relative overflow-hidden">
    ...
    >
      <img className="size-full object-cover object-top" src="/images/gradient-1.png" alt="Decorative gradient background" />
    </figure>
    <figure
      data-ns-animate
      data-delay="0.4"
    ...
    >
      <img className="size-full object-bottom" src="/images/gradient-2.png" alt="Decorative gradient background" />
    </figure>
    <div className="main-container px-5">
        ...
        <div className="col-span-12 xl:col-span-4">
          <div data-ns-animate data-delay="0.3" className="max-w-[306px]">
            ...
            <p className="text-accent/60 font-normal text-tagline-1 mt-4 mb-4">
              Ecadoc AI delivers blueprint intelligence for architecture, engineering, and construction teams.
            </p>
            <span className="badge badge-yellow mb-3">MVP Pilot • Testing Edition</span>
            <div className="flex items-center gap-3">
              {socials.map((social, index) => (
                <Fragment key={social.label}>
                  <a href={social.href} className="footer-social-link" aria-label={social.label}>
                    <img className="size-6" src={social.icon} alt={social.label} />
                  </a>
                  {index < socials.length - 1 && <div className="h-6 w-px bg-stroke-1/20" />}
                </Fragment>
              ))}
            </div>
            <p className="text-accent/80 font-normal text-tagline-1 mt-4">
              Ecadoc AI is currently operating as an MVP Testing Edition. Certain commercial features (billing, subscriptions, refunds) are inactive during this phase.
            </p>
          </div>
        </div>
        <div className="col-span-12 xl:col-span-8 grid grid-cols-12 gap-x-0 gap-y-8">
            ...
            <div data-ns-animate data-delay="0.4" className="space-y-8">
              ...
              <ul className="sm:space-y-5 space-y-3">
                {companyLinks.map((link) => (
                  <li key={link.label}>
                    {link.external ? (
                      <a href={link.href} className="footer-link" target="_blank" rel="noreferrer">
                        {link.label}
                      </a>
                    ) : (
          ...
          <div className="col-span-12 md:col-span-4">
            <div data-ns-animate data-delay="0.5" className="space-y-8">
              <p className="sm:text-heading-6 text-tagline-1 font-normal text-primary-50">Support</p>
              <ul className="sm:space-y-5 space-y-3">
      ...
      <div className="pt-[26px] pb-[100px] text-center relative">
        ...
        <p data-ns-animate data-delay="0.7" data-offset="10" data-start="top 105%" className="text-tagline-1 font-normal text-primary-50">
