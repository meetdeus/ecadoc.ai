    ...
    >
      <div className="main-container">
        <div className="text-center space-y-2 pb-14 lg:pb-[72px]">
          ...
          >
            Ecadoc AI is currently in its MVP Testing Edition. Commercial sales
            will begin later.
          </span>
        </div>
      </div>
        ...
        <div className="space-y-[70px]">
          <div className="max-w-[680px] mx-auto text-center space-y-3">
            ...
            <p data-ns-animate data-delay="0.3">
              Book a discovery call, schedule an on-site workshop, or request
              secure blueprint storage details. Our specialists respond within
              one business day to keep your projects moving.
            </p>
          </div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-2.5">
                    ...
                    <p className="text-accent/60">
                      <a href="mailto:kfiawoyife@capstruct.ca">
                        kfiawoyife@capstruct.ca
                      </a>
                    </p>
                  </div>
                </div>
      ...
      <div className="main-container">
        <div className="max-w-[680px] mx-auto text-center space-y-3 mb-8">
          ...
          <p data-ns-animate data-delay="0.2">
            Book an on-site session at Suite 1200, 401 W Georgia St, Vancouver,
            BC, or join virtually from anywhere.
          </p>
        </div>
        <div
          data-ns-animate
