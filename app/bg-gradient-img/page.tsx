...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      { url: '/images/aPD-K55xUNkB2D2X_og-image.jpg', width: 1200, height: 630, alt: 'NextSaaS - Software, SaaS & Startup Tailwind Template' }
    ]
  },
  twitter: {
...
<main className="bg-background-2 dark:bg-background-5">
  <section className="pt-28 md:pt-36 lg:pt-44 xl:pt-60 pb-20 md:pb-28 lg:pb-40 xl:pb-52 section-reveal">
    <div className="main-container">
      <div data-ns-animate data-delay="0.1" className="bg-background-3 dark:bg-background-5 rounded-4xl border-[10px] border-white dark:border-background-9 relative overflow-hidden flex flex-col justify-center items-center py-10 md:py-20 lg:py-[100px] text-center pr-2.5">
        <figure data-ns-animate data-delay="0.2" data-direction="right" data-offset={200} className="hero-gradient-2 absolute -top-[45%] sm:-top-[65%] -right-[68%] sm:-right-[48%] w-full -rotate-[68deg] h-full opacity-70 -z-0 pointer-events-none select-none">
          <img src="/images/gradient-6.png" alt="gradient" className="rotate-180" />
        </figure>
        <h1 data-ns-animate data-delay="0.3" className="text-[80px] md:text-[120px] lg:!text-[180px] xl:!text-[200px] font-medium leading-[1.1]">
          404
        </h1>
        ...
        <div data-ns-animate data-delay="0.6" data-instant>
          <a href="./" className="btn btn-lg btn-primary hover:btn-secondary dark:hover:btn-accent"><span>Go to Home</span></a>
        </div>
      </div>
    </div>
  </section>
