    ...
    <div className="main-container">
      <div className="text-center space-y-2 pb-14 lg:pb-[72px]">
        <span data-ns-animate data-delay="0.1" className="hero-badge text-tagline-1 inline-block text-secondary dark:text-accent">
          ...
          <a href="#" className="hover:text-primary-500 dark:hover:text-primary-400 transition-colors duration-300">Privacy policy</a>
        </span>
        <h1 data-ns-animate data-delay="0.2" className="font-normal lg:text-heading-2">Privacy policy</h1>
    ...
    <div className="main-container">
      <div className="space-y-[75px] privacy-policy">
        <div className="space-y-2">
          <h2 data-ns-animate data-delay="0.1">Data protection guidelines</h2>
          <p data-ns-animate data-delay="0.2">
            <span className="text-secondary dark:text-accent">Ecadoc AI</span> is a product operated by
            <span className="text-secondary dark:text-accent">Capstruct Inc</span>. Ecadoc AI provides intelligent blueprint reading and annotation features for AEC professionals to accelerate plan review and preserve project confidentiality securely promptly reliably accurately efficiently with precision for teams on site.
          </p>
        </div>
        <div data-ns-animate data-delay="0.3" className="space-y-2">
          <h4>Ecadoc AI privacy policy</h4>
          <p>
            This Privacy Policy explains how we collect use and disclose information when you access or use Ecadoc AI and related documentation
            <a href="https://ecadoc.ai" className="text-secondary dark:text-accent">
              https://ecadoc.ai
            </a>
            (the "Site").
          </p>
        ...
        <div data-ns-animate data-delay="0.4" className="space-y-6">
          <div className="space-y-2">
            ...
            <p>
              When you access the Site we automatically collect technical device details including browser type IP address time zone and cookie identifiers. Additionally we record which drawing pages you view which search terms or external links referred you and how you interact with documents for rendering and analytics purposes. "Device Information."
            </p>
          </div>
          <ul data-ns-animate data-delay="0.5" className="space-y-3 list-inside text-tagline-1 font-normal text-secondary/60 dark:text-accent/60">
            <li>
              <strong className="text-secondary dark:text-accent font-normal">Cookies</strong>
              Data files placed on your device often including an anonymous unique identifier.
              ( Learn more about cookies and how to disable them:
              <a href="http://www.allaboutcookies.org" className="text-secondary">
                http://www.allaboutcookies.org
              </a>
              )
            </li>
            <li>
              <strong className="text-secondary dark:text-accent font-normal">Log Files</strong>
              Track actions on the Site and collect IP address browser type referring pages and timestamps.
            </li>
            <li>
        ...
        <div>
          <div className="grid grid-cols-12 gap-y-[100px] lg:gap-[100px]">
            <div className="col-span-12 lg:col-span-6">
              <div data-ns-animate data-delay="0.6" className="text-left mb-[70px]">
                <p className="max-w-[550px]">
                  When you use subscription or purchase related features we may collect your name email billing address payment details and other information necessary to manage your account and invoices.
                </p>
              </div>
              <figure data-ns-animate data-delay="0.7" className="max-w-[595px] w-full overflow-hidden rounded-[20px] self-end">
                <img src="/images/privacy.png" className="size-full object-cover" alt="support-contact" />
              </figure>
            </div>
            <div data-ns-animate data-delay="0.8" className="col-span-12 lg:col-span-6">
              <form className="p-6 lg:p-[42px] rounded-[20px] bg-white dark:bg-background-8">
                <fieldset className="space-y-2 mb-8">
                  ...
                  <input type="text" name="name" id="name" placeholder="Enter your name" className="w-full block border dark:text-accent dark:bg-background-6 border-stroke-3 dark:border-stroke-7 bg-background-1 py-3 px-[18px] rounded-full h-12 focus-visible:outline focus-visible:outline-primary-500 placeholder:text-tagline-1 placeholder:font-normal placeholder:text-secondary/60 dark:placeholder:text-accent/60 shadow-1 font-normal" />
                </fieldset>
                <fieldset className="space-y-2 mb-8">
                  <label htmlFor="billing-shipping-addresses" className="text-tagline-1 text-secondary dark:text-accent font-medium block">
                    Phone
                  </label>
                  <input type="text" name="billing-shipping-addresses" id="billing-shipping-addresses" placeholder="Enter your phone number" className="w-full block border dark:text-accent dark:bg-background-6 border-stroke-3 dark:border-stroke-7 bg-background-1 py-3 px-[18px] rounded-full h-12 focus-visible:outline focus-visible:outline-primary-500 placeholder:text-tagline-1 placeholder:font-normal placeholder:text-secondary/60 dark:placeholder:text-accent/60 shadow-1 font-normal" />
                </fieldset>
                <fieldset className="space-y-2">
                  <label htmlFor="email" className="text-tagline-1 text-secondary dark:text-accent font-medium block">
                    Email address
                  </label>
                  <input type="text" name="email" id="email" placeholder="Enter your email address" className="w-full block border dark:text-accent dark:bg-background-6 border-stroke-3 dark:border-stroke-7 bg-background-1 py-3 px-[18px] rounded-full h-12 focus-visible:outline focus-visible:outline-primary-500 placeholder:text-tagline-1 placeholder:font-normal placeholder:text-secondary/60 dark:placeholder:text-accent/60 shadow-1 font-normal" />
                </fieldset>
                <fieldset className="space-y-2 mb-8">
                  <label htmlFor="payment-information" className="text-tagline-1 text-secondary dark:text-accent font-medium block">
                    Message
                  </label>
                  <input type="text" name="payment-information" id="payment-information" placeholder="Enter your message" className="w-full block border dark:text-accent dark:bg-background-6 border-stroke-3 dark:border-stroke-7 bg-background-1 py-3 px-[18px] rounded-full h-12 focus-visible:outline focus-visible:outline-primary-500 placeholder:text-tagline-1 placeholder:font-normal placeholder:text-secondary/60 dark:placeholder:text-accent/60 shadow-1 font-normal" />
                </fieldset>
                ...
                <button type="submit" className="btn dark:btn-accent btn-md btn-secondary hover:btn-primary w-full before:content-none first-letter:uppercase">
                  Submit
                </button>
              </form>
            </div>
        ...
        <div data-ns-animate data-delay="0.5" className="space-y-6">
          ...
          <ul className="space-y-3 list-inside text-tagline-1 font-normal text-secondary/60 dark:text-accent/60">
            <li>Process subscription payments generate invoices and receipts</li>
            <li>Communicate with you</li>
            <li>Screen for potential fraud and risks</li>
            <li>
              Provide you with product updates feature announcements and service notices when consistent with your preferences
            </li>
          </ul>
          <div>
            <p className="text-secondary dark:text-accent">We use the collected Account Information to:</p>
            <ul className="space-y-3 list-inside text-tagline-1 font-normal text-secondary/60 dark:text-accent/60">
        ...
        <div data-ns-animate data-delay="0.6" className="space-y-6">
          ...
          <ul className="space-y-3 list-inside text-tagline-1 font-normal text-secondary/60 dark:text-accent/60">
            <li>
              ...
              more:
              <a href="#" className="text-secondary dark:text-accent"> Google Privacy Policy </a>)
            </li>
        ...
        <div data-ns-animate data-delay="0.8" className="space-y-6">
          ...
          <ul className="space-y-3 list-inside text-tagline-1 font-normal text-secondary/60 dark:text-accent/60">
            ...
            <li>
              ...
              <a href="mailto:support@ecadoc.ai" className="text-secondary dark:text-accent">
                support@ecadoc.ai
              </a>
            </li>
          </ul>
        ...
        <div data-ns-animate data-delay="0.9" className="space-y-6">
          <div className="space-y-2">
            ...
            <p>
              We will retain your Account Information for our records unless you ask us to delete this
              information.
            </p>
          </div>
        </div>
        ...
        <div data-ns-animate data-delay="1.1" className="space-y-6">
          <div className="space-y-2">
            <h4>Changes</h4>
            <p>
              We may update this Privacy Policy periodically to reflect changes to our practices or for legal or operational reasons.
            </p>
          </div>
        </div>
      </div>
