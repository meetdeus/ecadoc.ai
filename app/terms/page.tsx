...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://www.ecadoc.ai/terms" },
};
      ...
      <div className="main-container">
        <div data-ns-animate data-delay="0.3" className="space-y-3">
          ...
          <div className="space-y-7">
            <p>
              Ecadoc.ai is owned and operated by Capstruct Inc. (‘Ecadoc’, ‘we’,
              ‘us’). These Terms govern customer use of our blueprint
              intelligence software, integrations, analytics, and professional
              services.
            </p>
            <p>
              Please read these Terms before enabling a workspace, installing
              integrations, uploading drawings, or inviting collaborators.
              Accessing the Service or signing an order form indicates
              acceptance on behalf of your organisation, project partners,
              contractors, and subcontractors who rely on issued credentials or
              API tokens daily.
            </p>
            <p>
              If you disagree with any provision, discontinue use immediately
              and contact legal@ecadoc.ai to discuss alternatives or request
              immediate export of workspace data backups.
            </p>
          </div>
        </div>
        <article className="terms-conditions-body">
          <div data-ns-animate data-delay="0.4" className="space-y-6">
            ...
            <p>
              Under no circumstances will Ecadoc be liable for indirect,
              incidental, consequential, exemplary, special, or punitive
              damages, including lost profits, lost savings, lost data, loss of
              goodwill, schedule delays, cost overruns, rework, or construction
              claims, even if advised of the possibility. Some jurisdictions
              limit exclusions, so certain rights may remain available to you,
              your affiliates, or project owners globally.
            </p>
            <p>
              Customers are responsible for repairing or replacing hardware,
              software, drawings, archives, or materials impacted by their use
              of the Service, integrations, or APIs, including pilot
              environments.
            </p>
          </div>
          <div data-ns-animate data-delay="0.5" className="space-y-6">
            <h3>2. License</h3>
            <p>
              Subscriptions grant a non-exclusive, non-transferable licence to
              access Ecadoc during the active term. Each licence covers the seat
              count or usage volume purchased, remains subject to these Terms,
              and requires timely payment.
            </p>
            <p>
              Licence keys and administrator credentials must stay confidential.
              You may not resell, rent, sublicense, lend, lease, or bypass
              technical controls that enforce workspace permissions, consumption
              limits, or geographic residency restrictions.
            </p>
          </div>
          <div data-ns-animate data-delay="0.6" className="space-y-6">
            <h3>3. Ownership and liability</h3>
            <p>
              Customer owns all uploaded drawings, annotations, models, reports,
              and derived measurements. Ecadoc processes that content only to
              deliver the Service, troubleshoot issues, or satisfy legal
              obligations.
            </p>
            <p>
              Ecadoc maintains administrative, technical, and physical
              safeguards—including encryption, network segmentation, least
              privilege access, monitoring, vulnerability management, audit
              logging, penetration tests, disaster recovery, and ongoing
              employee training—to protect confidential information entrusted to
              the platform.
            </p>
            <p>
              User accounts and product licences are{" "}
              <strong className="font-bold !text-secondary dark:!text-accent">
                non-transferable
              </strong>
              . Agencies must arrange separate agreements so every client
              receives support, audit trails, and admin controls without
          ...
          <div data-ns-animate data-delay="0.3" className="space-y-6">
            ...
            <p>
              We want you to love Ecadoc. New subscriptions include a thirty-day
              pilot; if expectations are not met, cancel within that window for
              a full subscription refund. Fees for implementation, migrations,
              training, or other professional services already delivered remain
              payable under their respective statements of work, engagement
              letters, formal purchase orders, invoices, and documented
              change-orders.
            </p>
          </div>
          ...
          <div data-ns-animate data-delay="0.5" className="space-y-6">
            <h3>5. Warranty</h3>
            <p>
              THE SERVICE IS PROVIDED ‘AS IS’ AND ‘AS AVAILABLE’. ECADOC MAKES
              NO WARRANTIES, EXPRESS OR IMPLIED, INCLUDING MERCHANTABILITY,
              FITNESS FOR A PARTICULAR PURPOSE, TITLE, OR NON-INFRINGEMENT.
              Continuous availability, perfect accuracy, uninterrupted
              integrations, or specific construction outcomes are not guaranteed
              by Ecadoc worldwide today.
            </p>
          </div>
          <div data-ns-animate data-delay="0.6" className="space-y-6">
            <h3>6. Account termination and suspension</h3>
            <p>
              We may suspend or terminate access if accounts are compromised,
              invoices remain unpaid, limits are exceeded, or activities
              threaten platform integrity.
            </p>
            <ul>
              <li>
                Abusive, defamatory, or malicious behavior towards NextSaaS
                staff or customers
              </li>
          ...
          <div data-ns-animate data-delay="0.3" className="space-y-6">
            ...
            <p>
              We respect your privacy. Ecadoc never sells personal data and
              shares information only with subprocessors necessary to operate
              the Service, as detailed in our Privacy Policy.
            </p>
            <ul>
            ...
            <p>
              Using Ecadoc authorises us to collect and process data consistent
              with this agreement, applicable law, and regional standards.
            </p>
          </div>
          <div data-ns-animate data-delay="0.4">
            <a
